...
def redistribution():
    data_file = os.listdir('/home/weizhaoyu/PycharmProjects/Dogs_vs_Cats_Pytorch/dogs_vs_cats/Dataset')
    dogs_file = list(filter(lambda x: x[:3] == 'dog', data_file))
    cats_file = list(filter(lambda x: x[:3] == 'cat', data_file))

    data_root = '/home/weizhaoyu/PycharmProjects/Dogs_vs_Cats_Pytorch/dogs_vs_cats/'
    train_root = '/home/weizhaoyu/PycharmProjects/Dogs_vs_Cats_Pytorch/dogs_vs_cats/train'
    val_root = '/home/weizhaoyu/PycharmProjects/Dogs_vs_Cats_Pytorch/dogs_vs_cats/val'
