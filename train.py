...
parser.add_argument('--total_epoch', default=200, help='time for ergodic')
parser.add_argument('--model', default='densenet201', help='model for training')
parser.add_argument('--outf', default='/home/weizhaoyu/wzy/quality_control_v1/model/', help='folder to output images and model checkpoints')  # 输出结果保存路径
...
# 图片导入
path = '/home/weizhaoyu/wzy/quality_control_v1/data/'
...
# 构建网络
use_model = feature_net(model, dim=94080, n_classes=2)
